...
const getContents = async () => {
    const res = await fetch("https://gist.githubusercontent.com/manzooralam/4b6aca6e1aa794c57c0cb6e7a2605109/raw/694828a0b1084ef63ff507ed85de3db6e3931e99/list.json");
    ...
    const html = 
        `<div class="col-lg-4 col-md-6 col-12 item-box">
            <div class="inner-box w-100">
                <div class="item-name me-3 w-50 w-md-75">${item.Name}</div>
                <div class="my-auto">
                <img class="me-2" src="https://via.placeholder.com/100" />
                </div>
            </div>
        </div>`
        home.innerHTML = home.innerHTML + html
